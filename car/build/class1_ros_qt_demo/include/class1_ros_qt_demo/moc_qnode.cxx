...
static const char qt_meta_stringdata_class1_ros_qt_demo__QNode[] = {
    "class1_ros_qt_demo::QNode\0\0loggingUpdated()\0"
    "rosShutdown()\0"
};
...
const QMetaObjectExtraData class1_ros_qt_demo::QNode::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject class1_ros_qt_demo::QNode::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_class1_ros_qt_demo__QNode,
      qt_meta_data_class1_ros_qt_demo__QNode, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &class1_ros_qt_demo::QNode::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_class1_ros_qt_demo__QNode))
