...
SbgErrorCode onLogReceived(SbgEComHandle *pHandle, SbgEComClass msgClass, SbgEComMsgId msg, const SbgBinaryLogData *pLogData, void *pUserArg)
{
  ...
  switch (msg){
    case SBG_ECOM_LOG_EKF_EULER:
      euler_angels_msg.vector.x = pLogData->ekfEulerData.euler[0];
      euler_angels_msg.vector.y = pLogData->ekfEulerData.euler[1];
      euler_angels_msg.vector.z = pLogData->ekfEulerData.euler[2];
