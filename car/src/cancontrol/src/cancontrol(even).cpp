...
//............................................................................
//避障算法
float Obstacle[2]={90.8, 90.55}; //(95,95)/40
//--->正常摆放在(0.75, 0.75)
...
float Kv = 0.25; //前视距离系数 0.12-0.15
float Kp = 0.8; //速度P控制器系数
float Ld0 = 0.125; //预瞄距离下限值 0.125
float dt = 0.1; //时间间隔
...
if(ifstart==0 || ultra_dis < 50 || allend==1 ) //未接收到路径点 或 超声波笔账 或 全部寻及结束 或 需要延时
